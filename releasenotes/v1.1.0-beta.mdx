...
|🐛 Bug Fix|Debug the web sockets latency issue that occasionally creates erratic typing behavior in text box|
|🐛 Bug Fix|Debug the latency between sending a message & clearing the input text box|